...
/**
 * Get all nurses from database and put them to request.
 */
public class NursesTag extends BodyTagSupport {
    ...
    private void otherDoStartTagOperations() {
        try {
            List<Nurse> allNurses =
                    DaoFactory.getInstance().getNurseDao().getAllNurses();
            
            HttpServletRequest request = (HttpServletRequest) pageContext.getRequest();
            request.setAttribute("allNurses", allNurses);
            ...
            Logger.getLogger(NursesTag.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in NursesTag tag", ex);
    }
